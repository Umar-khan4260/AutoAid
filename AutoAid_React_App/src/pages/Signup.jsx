                ...
                <div className="flex items-stretch w-full">
                    <div className="hidden lg:flex lg:w-1/2 items-center justify-center bg-gray-900 relative">
                        ...
                        <div className="relative z-10 text-center text-white p-12 max-w-lg">
                            <h2 className="text-4xl font-bold mb-4">Join the community of safe drivers.</h2>
                    ...
                    <div className="w-full lg:w-1/2 flex items-center justify-center p-4">
                        <div className="w-full max-w-md p-8 space-y-6 bg-card-dark rounded-lg shadow-xl border border-border-dark">
                            <div className="text-center">
                                <h1 className="text-3xl font-bold tracking-tight text-text-dark">Create Your Account</h1>
                                <p className="mt-2 text-subtle-dark">Become a member in just a few steps.</p>
                            </div>
                            <form onSubmit={handleSubmit} className="space-y-4">
                                <div>
                                    <label className="block text-sm font-medium text-subtle-dark" htmlFor="fullName">
                                        Full Name
                                    </label>
                                ...
                                <div>
                                    ...
                                    <div className="mt-1 relative">
                                        ...
                                        <input
                                            autoComplete="email"
                                            className={`block w-full pl-10 pr-3 py-2 border ${errors.email ? 'border-red-500' : 'border-border-dark'
                                                } rounded-md shadow-sm placeholder-gray-500 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm bg-gray-700 text-text-dark`}
                                            id="email"
                                            name="email"
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-subtle-dark" htmlFor="contactNumber">
                                        Contact Number
                                    </label>
                                    <div className="mt-1 relative">
                                ...
                                <div>
                                    ...
                                    <div className="mt-1 relative">
                                        ...
                                        <input
                                            autoComplete="new-password"
                                            className={`block w-full pl-10 pr-3 py-2 border ${errors.confirmPassword ? 'border-red-500' : 'border-border-dark'
                                                } rounded-md shadow-sm placeholder-gray-500 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm bg-gray-700 text-text-dark`}
                                            id="confirmPassword"
